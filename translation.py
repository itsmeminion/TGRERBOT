...
This is a Telegram Rename clone of <a href='@CB_RenamerBot'>Renamer CB BOT</a> by {}
...
Type /help for more details."""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using [CineBin](https://t.me/CineBin)'s bot.**"
    ...
    CUSTOM_CAPTION_UL_FILE = "@@CB_RenamerBot"
...
<b>Thanks to <i><a href="https://t.me/CineBin">CineBin 👨‍🏫</a></i> for his source code. check /about for source code</b>

--------

Support Group : @CineBin"""
...
**👨‍💻 Developer:** [CineBin](https://t.me/abtmesk)

**📮 Channel:** [NS BOT UPDATES](https://t.me/CB_Bots)

**👥 Group:** [NS BOT SUPPOTERS](https://t.me/CB_Bots/10)
